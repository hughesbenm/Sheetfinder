...
const SaveRow = ({saveType}: SaveRowProps) => {
	...
	return <GridRow>
		...
		<GridNumberSource mod size={1} label={"Base Save"} value={save.base} setValue={handleBaseSave} position={"bottom"}/>
		<GridSink size={1} label={save.ability + " Mod"} value={modPlus(abilityMod)} position={"bottom"}/>
		<GridNumberSource mod size={1} label={"Misc Mod"} value={save.miscMod} setValue={handleMiscMod} position={"bottom"}/>
		<GridNumberSource mod size={1} label={"Temp Mod"} value={save.tempMod} setValue={handleTempMod} position={"bottom"}/>
